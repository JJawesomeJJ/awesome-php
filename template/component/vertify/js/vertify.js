...
function Slidevertify(success_call_back,fail_call_back) {
    ...
    $(".vertify_container").css("background-image", "url(" + "http://39.108.236.127/php/public/index.php/vertify?" + Date.parse(new Date()) + ")");
    function vertify_x(x) {
        $.ajax({
            type: "POST",
            url: "http://39.108.236.127/php/public/index.php/vertify/silde/x",
            data: {x: x},
            dataType: "json",
